...
class CircleGraph {
    constructor(parent, circleGraphContainer, noArea=false, readonly=false) {
        this._points = [];
        this._parent=parent;
    ...
    set points(value) {
        setPoints(this, value, this._readonly);
    }
    set update(value) {
        redraw(this, this._noArea);
...
function setPoints(self, points, readonly=false) {
    ...
    for(let i = 0; i < points.length; i++) {
        ...
        const drawPoint = new Point(self, readonly);
...
function redraw(self, noArea=false) {
    let container;
    _sortPoints(self);
